...
const PricingSection = () => {
  ...
  const materials = [
    { value: 'posters', label: 'Campaign Posters', basePrice: 150, unit: 'per piece' },
    { value: 'banners', label: 'Rally Banners', basePrice: 2500, unit: 'per banner' },
    { value: 'tshirts', label: 'Campaign T-shirts', basePrice: 800, unit: 'per shirt' },
    { value: 'flyers', label: 'Campaign Flyers', basePrice: 25, unit: 'per piece' },
    { value: 'stickers', label: 'Campaign Stickers', basePrice: 15, unit: 'per piece' },
    { value: 'vehicle', label: 'Vehicle Branding', basePrice: 25000, unit: 'per vehicle' }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="font-body font-body-semibold">
                      KES {(materials?.find(m => m?.value === selectedMaterial)?.basePrice * quantity)?.toLocaleString()}
                    </span>
                  </div>
                  ...
                  {bulkDiscount > 0 && (
                    <div className="flex justify-between text-success">
                      ...
                      <span className="font-body font-body-semibold">
                        -KES {bulkDiscount?.toLocaleString()}
                      </span>
                    </div>
                  )}
                  ...
                  <div className="border-t border-border pt-2 mt-4">
                    <div className="flex justify-between">
                      <span className="font-headline font-headline-bold text-lg text-text-primary">
                        Total Price:
                      </span>
                      <span className="font-headline font-headline-bold text-xl text-primary">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {pricingTiers?.map((tier, index) => (
            <div
              key={index}
              className={`relative bg-card rounded-2xl p-8 shadow-sm border-2 ${tier?.color} ${
            ...
            >
              ...
              <div className="text-center mb-8">
                <h3 className="font-headline font-headline-bold text-xl text-text-primary mb-2">
                  {tier?.name}
                </h3>
                <div className="font-headline font-headline-bold text-3xl text-primary mb-2">
                  {tier?.price}
                </div>
